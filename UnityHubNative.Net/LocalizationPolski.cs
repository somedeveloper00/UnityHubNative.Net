...
class LocalizationPolski : ILocalization
{
    ...
    public string ProjectTitleBold => "Pogrub tytuł projektu";
    public string ProjectTitleBold_Tooltip => "Jeśli włączone, tytuł projektu będzie wyświetlany pogrubioną czcionką";
